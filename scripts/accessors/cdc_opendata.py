...
if __name__ == "__main__":
    ...
    print("Sample COVID-19 data (California):")
    try:
        covid = cdc.get_covid_cases(state="CA", limit=5)
        print(covid[['submission_date', 'state', 'tot_cases', 'new_case', 'tot_death']].to_string())
    except Exception as e:
        print(f"Error: {e}")
    
    print("\n" + "=" * 60 + "\n")
    
    print("Notifiable diseases (first 10):")
