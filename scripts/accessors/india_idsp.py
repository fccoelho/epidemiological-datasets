...
def main():
    """
    Example usage of IndiaIDSPAccessor.
    """
    print("=" * 70)
    print("India IDSP (Integrated Disease Surveillance Programme) Accessor")
    print("=" * 70)

    idsp = IndiaIDSPAccessor()

    # List states
    print("\n🇮🇳 Indian States (sample):")
    ...
    print("  )")
    print("  weekly = idsp.get_weekly_surveillance_summary(")
    print("      year=2024, week=10")
    print("  )")

    print("\n✅ India IDSP accessor ready to use!")
    print("\n⚠️  Note: IDSP data requires portal access at https://idsp.nic.in/")
