...
class AfricaCDCAccessor(BaseAccessor):
    """
    ...
    source_name: ClassVar[str] = "africa_cdc"
    source_description: ClassVar[str] = (
        "Africa CDC public health surveillance data including disease outbreaks, "
        "COVID-19 surveillance, vaccination coverage, and event-based surveillance"
    )
    source_url: ClassVar[str] = "https://africacdc.org"
