...
class ECDCOpenDataAccessor(BaseAccessor):
    """
    ...
    source_name: ClassVar[str] = "ecdc"
    source_description: ClassVar[str] = "ECDC Open Data - European infectious disease surveillance (Atlas, AER, CDTR)"
    source_url: ClassVar[str] = "https://atlas.ecdc.europa.eu/"
