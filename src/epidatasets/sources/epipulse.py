...
class EpiPulseAccessor(BaseAccessor):
    """
    ...
    source_name: ClassVar[str] = "epipulse"
    source_description: ClassVar[str] = "ECDC EpiPulse - European surveillance portal for infectious diseases (TESSy, EPIS)"
    source_url: ClassVar[str] = "https://epipulse.ecdc.europa.eu/"
    ...
    def list_countries(self) -> pd.DataFrame:
        return self.get_available_countries(region="all")
