...
class MalariaAtlasAccessor(BaseAccessor):
    """
    ...
    source_name: ClassVar[str] = "malaria_atlas"
    source_description: ClassVar[str] = (
        "Malaria data from the Malaria Atlas Project including parasite rate "
        "survey data, vector occurrence data, administrative boundaries, and "
        "modeled raster surfaces of malaria burden and risk."
    )
    source_url: ClassVar[str] = "https://data.malariaatlas.org/"
