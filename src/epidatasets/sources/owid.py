...
class OWIDAccessor(BaseAccessor):
    """
    ...
    source_name: ClassVar[str] = "owid"
    source_description: ClassVar[str] = (
        "Comprehensive health datasets from Our World in Data, including "
        "COVID-19 data, vaccination data, excess mortality, health inequality "
        "metrics, and disease burden data."
    )
    source_url: ClassVar[str] = "https://ourworldindata.org/health"
