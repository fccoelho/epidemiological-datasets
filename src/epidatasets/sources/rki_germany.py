...
class RKIGermanyAccessor(BaseAccessor):
    """
    ...
    source_name: ClassVar[str] = "rki"
    source_description: ClassVar[str] = (
        "Robert Koch Institute (RKI) infectious disease surveillance data "
        "including COVID-19, influenza, notifiable diseases, vaccination "
        "coverage, and antimicrobial resistance for Germany."
    )
    source_url: ClassVar[str] = "https://www.rki.de/EN/Content/infections/epidemiology/data.html"
    ...
    def list_countries(self) -> pd.DataFrame:
        """Return Germany as the sole country covered by this source."""
        return pd.DataFrame([{"country_code": "DE", "country_name": "Germany"}])
