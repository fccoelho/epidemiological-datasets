...
class UKHSAAccessor(BaseAccessor):
    """
    ...
    source_name: ClassVar[str] = "ukhsa"
    source_description: ClassVar[str] = (
        "UK Health Security Agency (UKHSA) public health surveillance data "
        "including infectious diseases, immunization coverage, and "
        "respiratory illness tracking."
    )
    source_url: ClassVar[str] = "https://api.ukhsa-dashboard.data.gov.uk/"
